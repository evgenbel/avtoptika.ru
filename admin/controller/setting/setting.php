...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            //нужен хак, если в основном магазине меняется телефон, то он меняется на всех.
            $this->model_setting_setting->updPhone();
            $this->model_setting_setting->updPhoneYandex();
            $this->model_setting_setting->updEmail();
		...
		if (isset($this->error['banner_name'])) {
			$this->data['error_banner_name'] = $this->error['banner_name'];
		} else {
			$this->data['error_banner_name'] = '';
		}
		
		if (isset($this->error['banner_old_price'])) {
			$this->data['error_banner_old_price'] = $this->error['banner_old_price'];
		} else {
			$this->data['error_banner_old_price'] = '';
		}
		
		if (isset($this->error['banner_new_price'])) {
			$this->data['error_banner_new_price'] = $this->error['banner_new_price'];
		} else {
			$this->data['error_banner_new_price'] = '';
		}
		
		if (isset($this->error['banner_text1'])) {
			$this->data['error_banner_text1'] = $this->error['banner_text1'];
		} else {
			$this->data['error_banner_text1'] = '';
		}
		
		if (isset($this->error['banner_text2'])) {
			$this->data['error_banner_text2'] = $this->error['banner_text2'];
		} else {
			$this->data['error_banner_text2'] = '';
		}
		
		if (isset($this->error['zakaz_form_title'])) {
			$this->data['error_zakaz_form_title'] = $this->error['zakaz_form_title'];
		} else {
			$this->data['error_zakaz_form_title'] = '';
		}
		...
		if (isset($this->request->post['zakaz_form_title'])) {
			$this->data['zakaz_form_title'] = $this->request->post['zakaz_form_title'];
		} else {
			$this->data['zakaz_form_title'] = $this->config->get('zakaz_form_title');
		}
		
		if (isset($this->request->post['banner_name'])) {
			$this->data['banner_name'] = $this->request->post['banner_name'];
		} else {
			$this->data['banner_name'] = $this->config->get('banner_name');
		}
		
		if (isset($this->request->post['banner_old_price'])) {
			$this->data['banner_old_price'] = $this->request->post['banner_old_price'];
		} else {
			$this->data['banner_old_price'] = $this->config->get('banner_old_price');
		}
		
		if (isset($this->request->post['banner_new_price'])) {
			$this->data['banner_new_price'] = $this->request->post['banner_new_price'];
		} else {
			$this->data['banner_new_price'] = $this->config->get('banner_new_price');
		}
		
		if (isset($this->request->post['banner_text1'])) {
			$this->data['banner_text1'] = $this->request->post['banner_text1'];
		} else {
			$this->data['banner_text1'] = $this->config->get('banner_text1');
		}
		
		if (isset($this->request->post['banner_text2'])) {
			$this->data['banner_text2'] = $this->request->post['banner_text2'];
		} else {
        ...
        if (isset($this->request->post['config_add_emails'])) {
            $this->data['config_add_emails'] = $this->request->post['config_add_emails'];
        } else {
            $this->data['config_add_emails'] = $this->config->get('config_add_emails');
        }

        if (isset($this->request->post['optika_new_config_telephone_yandex'])) {
            $this->data['config_telephone_yandex'] = $this->request->post['optika_new_config_telephone_yandex'];
        } else {
            $this->data['config_telephone_yandex'] = $this->config->get('optika_new_config_telephone_yandex');
        }

        if (isset($this->request->post['config_telephone_yandex'])) {
            $this->data['config_telephone_yandex'] = $this->request->post['config_telephone_yandex'];
        } else {
        ...
        if (isset($this->request->post['work_from_work'])) {
            ...
            $this->data['work_from_work'] = $this->config->get('work_from_work');
        }

        if (isset($this->request->post['work_to_work'])) {
            $this->data['work_to_work'] = $this->request->post['work_to_work'];
        } else {
            $this->data['work_to_work'] = $this->config->get('work_to_work');
        }

        if (isset($this->request->post['work_from_sat'])) {
            $this->data['work_from_sat'] = $this->request->post['work_from_sat'];
        } else {
            $this->data['work_from_sat'] = $this->config->get('work_from_sat');
        }

        if (isset($this->request->post['work_to_sat'])) {
            $this->data['work_to_sat'] = $this->request->post['work_to_sat'];
        } else {
            $this->data['work_to_sat'] = $this->config->get('work_to_sat');
        }

        if (isset($this->request->post['work_from_sun'])) {
            $this->data['work_from_sun'] = $this->request->post['work_from_sun'];
        } else {
            $this->data['work_from_sun'] = $this->config->get('work_from_sun');
        }

        if (isset($this->request->post['work_to_sun'])) {
            $this->data['work_to_sun'] = $this->request->post['work_to_sun'];
        } else {
            $this->data['work_to_sun'] = $this->config->get('work_to_sun');
        }
