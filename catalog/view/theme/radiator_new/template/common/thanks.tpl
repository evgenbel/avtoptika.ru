...
<script type="text/javascript">(window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=GTHT3n2KWDRBdvO0o5tVURZMPZa2HhgPO0RxmtYhxzvMDuzifb1E*1Omyv86Zm6EGtql5Jfor7Jwrh50UbeepZtY78SutJ*3nPDAj09bast6Oio5rgZfOHEqGa2f4QaZU6ZNoouxs8AYWcc0yvV6s*AdbJwoFx96BZDMRNJER94-';</script>
...
<div id="wrapper" >
    ...
    <div id="header">
		...
		<ul class="phone_list">
			...
			$phone=explode(" ",$phone); 
			?>
			<li class="phonen call_phone_3">
                <a href="tel: +7 <?php echo isset($phone[1])?$phone[0]:499 ?> <?php echo isset($phone[1])?$phone[1]:$phone[0]; ?>">
                    8 <span>(499)</span> <span ><?php echo isset($phone[1])?$phone[1]:$phone[0]; ?></span>
                </a>
            </li>
...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
        ...
        ga('create', 'UA-51302022-12', 'zapparts.ru+calltouch');
