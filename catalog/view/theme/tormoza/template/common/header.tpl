...
<body>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-525CVB"
				  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-525CVB');</script>
...
<script type="text/javascript">(window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=kWka/CMV0id4tC/Wxhc64OnYqPNw*rWnTtvF9pffypFeCKsVuFvWAoG2BUy7xqNFgKAQp/Et3gWoGVFN1FlCi24MR9/*h01ITmXS0Ik3H0u9Yu33fzHFVHEoaOWzj/*5EK9VBVb7JRqIIbdsueJsZttcmHGlGmYYwbtiYasoOkQ-';</script>
 ...
 <script>
    ...
    <div id="wrapper">
		...
		<?php //} else { ?>
			<div id="expander1" class="bottom_email_expander" style="display:none;z-index:5003;bottom:0px;width:1200px;"><p style="margin-bottom:15px;font-size:25px;text-align:center;color:#ffffff;font-weight:bold;text-shadow:#008bc8 2px 0px, #008bc8 -2px 0px, #008bc8 0px -2px, #008bc8 0px 2px;"><a onclick="toggleInfo();">Как правильно выбрать тормозные колодки. И насколько это важно!</a> >>> <span style="font-size:20px;color:black;text-shadow:none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Читать</span><img style="height:20px;" src="catalog/view/theme/tormoza/image/show.png" /></p></div>
		<?php //} ?>
		<div class="bottom_email"><p style="margin-bottom:15px;font-size:25px;font-size:25px;text-align:center;color:#ffffff;font-weight:bold;text-shadow:#008bc8 2px 0px, #008bc8 -2px 0px, #008bc8 0px -2px, #008bc8 0px 2px;background:#696969;"><a onclick="toggleInfo();">Как правильно выбрать тормозные колодки. И насколько это важно!</a></p>
	...
	<div class="clear"></div>
        <div class='title-search'>			
            <?php if (!empty($search_phrase)):?>
				...
				?>
            <?php else:?>
                Тормозные диски, колодки для иномарок
            <?php endif;?>
