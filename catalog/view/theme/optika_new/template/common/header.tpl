...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-NW2445"
				  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-NW2445');</script>
...
<!-- //Rating@Mail.ru counter -->
 ...
 <script>
	...
	<div id="header">
		<a href="/"><div style="width:400px;height:155px;position:absolute;"></div></a>
		<ul class="phone_list">
			<li>ООО "ZAPPARTS"</li>
			<?php 
			$phone=$this->config->get('config_telephone');
			...
			<li class="phonen <?php if($yandexphone): ?>call_phone_3<?php endif;?>">
                <a href="tel: +7 <?php echo isset($phone[1])?$phone[0]:499 ?> <?php echo isset($phone[1])?$phone[1]:$phone[0]; ?>">
                    8 <span <?php if($yandexphone): ?>class="ya_code" <?php else: ?> class="ya_code1"<?php endif;?>>(<?php echo isset($phone[1])?$phone[0]:499 ?>)</span> <?php echo isset($phone[1])?$phone[1]:$phone[0]; ?>
                </a>
            </li>
	...
	<div class="clear"></div>
        <div class='title-search'>
            <?php if (!empty($search_phrase)):?>
				...
				?>
            <?php else:?>
                Фары, фонари, противотуманки для иномарок
            <?php endif;?>
