		...
		<form action="">
			<div class="form_order">
				...
				<ul class="form_list">
					...
					<li style="margin-top: 24px;"><span>Комментарии</span><textarea placeholder="Марка машины и нужная деталь" default="Марка машины и нужная деталь" class="usertxt <?php if (!empty($search_phrase)):?>fr_s<?endif;?>" cols="" rows=""><?php echo empty($search_phrase)?"":switcher2($search_phrase, 1)?></textarea></li>
...
<script type="text/javascript">
	(function (d, w, c) {
		(w[c] = w[c] || []).push(function() {
			try {
				w.yaCounter33314420 = new Ya.Metrika({id:33314420,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/33314420" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->

<script>
function reachGoalSite(name){
	yaCounter33314420.reachGoal(name);
}
</script>
<?php if($yandexphone): ?>
<script type="text/javascript">
