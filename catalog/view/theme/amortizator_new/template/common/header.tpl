...
<body>
<!-- Google Tag Manager -->
<!--noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KWM9P5"
				  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KWM9P5');</script-->
		...
		<div class="top_line">
			<div class="title_site"><a href="/">ZAPPARTS</a></div>
				<div class="phone_line">
					<p class="phone_2 call_phone_5" style="color:red;font-size: 30px;font-weight: bold;font-family: Arial;">
	...
	<div class="clear"></div>
        <div class='title-search'>
            <?php if (!empty($search_phrase)):?>
				...
				?>
            <?php else:?>
                Амортизаторы подвески, опорные подшипники для иномарок
            <?php endif;?>
	...
	<div id="top_block">
		...
		<div class="slider">
			...
			<ul>
				...
				<img class="spec" src="/image/<?php echo $config_banner; ?>" width="694" height="240" />
