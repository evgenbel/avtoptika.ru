...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter20764234 = new Ya.Metrika({id:20764234,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/20764234" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->

<script>
function reachGoalSite(name){
    yaCounter20764234.reachGoal(name);
}
</script>
    <?php if($yandexphone): ?>
    <script type="text/javascript">
