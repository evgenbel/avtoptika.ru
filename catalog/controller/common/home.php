...
class ControllerCommonHome extends Controller {
	...
	public function callTouch() {		
        ...
        if (!empty($calltouch)){
            $calltouch1 = json_decode($calltouch);
            if (isset($calltouch1->order)) $_SESSION['calltouchOrderNumber'] = $calltouch1->order->orderNumber;
            echo json_encode(array("success"=>1, "res"=>$calltouch));
        }
